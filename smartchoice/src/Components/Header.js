                ...
                <div className='header__content'>
                    <div className='header__contentUp'>
                        <div className='header__logo'>
                            <Link to='/' >
                                <img className='header__logoImg' src='\Images\Main Logologo.png' alt='Smart Choice logo'/>
                            </Link>
                            <div className='header__search'>
                                <div className='header__menu'>
                                    <Toolbar className='header__menuHd' >
                                        ...
                                        <div ref={ref} className={showMenu? 'header__menuShow' : 'menuHide' }>
                                            {categories.map((item, index) => (
                                                <MenuItem onClick={() => { setShowMenu(false)}} className='header header__menuOption' key={index}>{item.icon}<span className='header__menuText'>{item.option}</span></MenuItem>
                                            ))}
                                        </div>
                                    </Toolbar>
                                        <Divider orientation='vertical' variant='middle' flexItem/>
                                        <MenuItem className='header__menuDesk'>
                                            <Button onClick={gotoHero} className='menuBtn' size='medium' variant='text'>Home</Button>
                                        </MenuItem>
                                        <MenuItem className='header__menuDesk'>
                                            <Button onClick={gotoMarket} className='menuBtn' size='medium' variant='text'>MarketPlace</Button>
                                        </MenuItem>
                                        <MenuItem className='header__menuDesk'>
                                            <Button onClick={gotoTrend} className='menuBtn' size='medium' variant='text'>Trending-products</Button>
                                        </MenuItem>
                                        <MenuItem className='header__menuDesk'>
                                            <Button className='menuBtn' size='medium' variant='text'>Newsletter</Button>
                                        </MenuItem>
                                </div>
                        ...
                        <div className='header__help'>
                            <ButtonGroup size='medium' variant='text'>
                                ...
                                <div className='header__contact'>
                                    <Button onClick={findHelp} className='header__contactUs'>Contact us</Button>
